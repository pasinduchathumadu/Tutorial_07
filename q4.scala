object q4 extends App {
  ...
  val account1= new BankAccount1("Kamal",22344,10500.00)
  val account2= new BankAccount1("Namal",32428,5700.00)
  val account3= new BankAccount1("Bimal",12030,1890.00)
  val account4= new BankAccount1("Sunimal",12040,-3000.00)
